import { Briefcase, Download, FileText, FlaskConical, GraduationCap, Home, User, Users, X } from "lucide-react";

function SelectedApp({setSelectedApp,selectedApp, handleStatusChange,triggerToast}) {
    return ( 
